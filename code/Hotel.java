...
public class Hotel {
    ...
    public ReservationSystem makeReservation(String firstName, String lastName, String phoneNumber, Date arrivalDate,
        ...
        int reservationNumber = ReservationSystem.generateReservationNumber(room);
        ReservationSystem reservation = new ReservationSystem(firstName, lastName, phoneNumber, reservationNumber,
                arrivalDate, departureDate, roomType, numAdults, numChildren, includesBreakfast);
